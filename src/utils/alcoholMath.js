...
/**
 * Calcula la Tasa de Alcoholemia Estimada (g/L) con absorción progresiva de 45 mins
 */
export const calcularBacEst = (history, peso, sexo, minsPerUbe) => {
  ...
  const TIEMPO_ABSORCION_MS = 45 * 60 * 1000; // 45 minutos
